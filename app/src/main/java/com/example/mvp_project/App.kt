...
import com.example.mvp_project.data.userrepo.ForgetPasswordUseCaseImpl
import com.example.mvp_project.data.userrepo.LoginUseCaseImpl
import com.example.mvp_project.data.userrepo.RegistrationUseCaseImpl
import com.example.mvp_project.data.userrepo.RoomLoginApiImpl
...
class App : Application() {
    ...
    override fun onCreate() {
        super.onCreate()
        db = Room.databaseBuilder(this, AccountsDataBase::class.java, "Accounts.db").build()
    }
